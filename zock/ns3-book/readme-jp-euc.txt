...
これらのコードを以下のように、ns3 のホームディレクトリにコピーして利用する。
  ...
  % cp -r ~/ns3-book/local   ns-3.xx/.
  % cp -r ~/ns3-book/wlan   ns-3.xx/.
...
検証済みバージョン：
	ns-3.15, ns-3.16, ns-3.17, ns-3.18, ns-3.18.1 , ns-3.18.2, ns-3.19
	なお、ns-3.17からwscriptの記述方法は少し変わった。

	Ubuntu 12.04 LTS, Ubuntu 13.04, Ubuntu 13.10 JP
